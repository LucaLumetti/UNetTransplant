...
pretrains = [
    (
        "Naive",
        f"{base_path}/checkpoints/PretrainExperiment_ciemotpb_pretrain/checkpoint_50_2025-02-09 18:00:05.589000.pth",
    ),
    (
        "Stable",
        f"{base_path}/checkpoints/PretrainExperiment_kzsmdcc6_pretrain_stable/checkpoint_48_2025-02-09 17:53:31.384283.pth",
    ),
    (
        "Old",
        f"{base_path}/checkpoints/PretrainExperiment_None_pretrain_old/checkpoint_325_2025-02-02 01:55:56.247190.pth",
    ),
]
...
checkpoints_path = (
    Path("/leonardo_scratch/large/userexternal/llumetti/output_UNetMerging/")
    / "checkpoints"
)
checkpoints_path = [
    x
...
for checkpoint_path in checkpoints_path:
    tv_task_name = checkpoint_path.name.split("__")[1].split("_")[0]
    tv_pretrain_kind = checkpoint_path.name.split("__")[1].split("_")[1]
    if "+" in tv_task_name:
        continue
